...
region_df = organise_data_into_regions_funcs.find_regions(
    ...
    region_classifcation_output_dir=Path("/home/arr65/data/nzgd/region_classification"))
...
organise_data_into_regions_funcs.organise_records_into_regions(
    analysis_ready_data=True,
    dry_run=False,
    unorganised_root_dir_to_copy_from=Path("/home/arr65/data/nzgd/analysis_ready_data/cpt/data"),
    organised_root_dir_to_copy_to=Path("/home/arr65/data/nzgd/hypocentre_mirror/nzgd/analysis_ready"),
    region_df=region_df)
